    ...
    body: Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            'We sent a 6-digit verification code to ${context.watch<AuthProvider>().pendingSignup?['email'] ?? 'your email'}.',
            textAlign: TextAlign.center,
          ),
          const SizedBox(height: 28),
          TextField(
          ...
          ElevatedButton(
            onPressed: context.watch<AuthProvider>().isLoading ? null : _verify,
